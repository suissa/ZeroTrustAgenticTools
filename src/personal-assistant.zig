...
pub fn main() !void {
    try common.run(.{
        .name = "ztat-personal-assistant",
        .domain = "personal assistant",
        .purpose = "calendar plans, task prioritization, travel preparation, reminders",
        .capabilities = &.{ "calendar plans, task prioritization, travel preparation, reminders", "validates all input as untrusted", "returns plan-only JSON by default", "requires scoped capability tokens for side effects" },
