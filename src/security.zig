...
pub fn main() !void {
    try common.run(.{
        ...
        .capabilities = &.{ "alert triage, threat modeling, policy review, incident runbooks", "validates all input as untrusted", "returns plan-only JSON by default", "requires scoped capability tokens for side effects" },
