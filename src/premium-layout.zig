...
pub fn main() !void {
    try common.run(.{
        .name = "ztat-premium-layout",
        .domain = "premium layout creation",
        .purpose = "layout briefs, design tokens, component plans, accessibility checks",
        .capabilities = &.{ "layout briefs, design tokens, component plans, accessibility checks", "validates all input as untrusted", "returns plan-only JSON by default", "requires scoped capability tokens for side effects" },
