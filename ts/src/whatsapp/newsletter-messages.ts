...
const spec = {
  name: makeToolName("ztat-ts-wa-newsletter-messages"),
  domain: makeDomain("whatsapp newsletter operations"),
  purpose: makePurpose("Get newsletter messages"),
  capabilities: [
    makeCapability("Get newsletter messages"),
