...
const spec = {
  name: makeToolName("ztat-ts-wa-chat-history-sync-request"),
  domain: makeDomain("whatsapp chat operations"),
  purpose: makePurpose("HistorySyncRequest a chat"),
  capabilities: [
    makeCapability("HistorySyncRequest a chat"),
