...
const spec = {
  name: makeToolName("ztat-ts-wa-group-description"),
  domain: makeDomain("whatsapp group operations"),
  purpose: makePurpose("Set group description"),
  capabilities: [
    makeCapability("Set group description"),
