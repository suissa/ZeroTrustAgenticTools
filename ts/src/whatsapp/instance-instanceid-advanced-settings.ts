...
const spec = {
  name: makeToolName("ztat-ts-wa-instance-instanceid-advanced-settings"),
  domain: makeDomain("whatsapp instance operations"),
  purpose: makePurpose("Get advanced settings"),
  capabilities: [
    makeCapability("Get advanced settings"),
