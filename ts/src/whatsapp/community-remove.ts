...
const spec = {
  name: makeToolName("ztat-ts-wa-community-remove"),
  domain: makeDomain("whatsapp community operations"),
  purpose: makePurpose("Remove participant from community"),
  capabilities: [
    makeCapability("Remove participant from community"),
