...
const spec = {
  name: makeToolName("ztat-ts-wa-polls-pollmessageid-results"),
  domain: makeDomain("whatsapp polls operations"),
  purpose: makePurpose("Get poll results"),
  capabilities: [
    makeCapability("Get poll results"),
