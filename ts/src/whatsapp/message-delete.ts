...
const spec = {
  name: makeToolName("ztat-ts-wa-message-delete"),
  domain: makeDomain("whatsapp message operations"),
  purpose: makePurpose("Delete a message for everyone"),
  capabilities: [
    makeCapability("Delete a message for everyone"),
